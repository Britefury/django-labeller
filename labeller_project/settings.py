"""
Django settings for labeller_project project.
...
SECRET_KEY = 'hivnec&7h=wb*f4$w7gr44*l7wa5xqp((49=j%keaq52&t%u6z'
...
ROOT_URLCONF = 'labeller_project.urls'
...
WSGI_APPLICATION = 'labeller_project.wsgi.application'
...
LABEL_CLASSES = [
    labelling_tool.LabelClassGroup('Dysplasia', [
        labelling_tool.LabelClass('benign', 'Benign', dict(default=[0, 255, 192], natural=[0, 255, 192],
                                                        artificial=[128, 128, 128])),
        labelling_tool.LabelClass('mild_dysplasia', 'Mild', dict(default=[0, 128, 255], natural=[0, 128, 255],
                                                       artificial=[128, 128, 128])),
        labelling_tool.LabelClass('moderate_dysplasia', 'Moderate', dict(default=[255, 96, 192], natural=[255, 192, 96],
                                                           artificial=[128, 128, 128])),
        labelling_tool.LabelClass('severe_dysplasia', 'Severe', dict(default=[65, 255, 0], natural=[65, 255, 0],
                                                       artificial=[128, 128, 128])),
        labelling_tool.LabelClass('carcinoma', 'Carcinoma', dict(default=[128, 64, 0], natural=[128, 64, 0],
                                                       artificial=[128, 128, 128])),
        labelling_tool.LabelClass('low_grade', 'low grade', dict(default=[65, 255, 0], natural=[65, 255, 0],
                                                       artificial=[128, 128, 128])),
        labelling_tool.LabelClass('high_grade', 'high grade', dict(default=[128, 64, 0], natural=[128, 64, 0],
                                                       artificial=[128, 128, 128])),
    ]),
