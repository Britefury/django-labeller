...
class LabellingToolView (View):
    ...
    def get(self, request, *args, **kwargs):
        #print(' LabellingToolView GET request')
    ...
    def post(self, request, *args, **kwargs):
        print(' LabellingToolView POST request')
...
class LabellingToolViewWithLocking (LabellingToolView):
    ...
    def get(self, request, *args, **kwargs):
        if 'labels_for_image_id' in request.GET:
            #print('\n', 'LabellingToolViewWithLocking GET request')
            image_id_str = request.GET['labels_for_image_id']
    ...
    @method_decorator(never_cache)
    def post(self, request, *args, **kwargs):
        #print('\n', 'LabellingToolViewWithLocking POST request')
